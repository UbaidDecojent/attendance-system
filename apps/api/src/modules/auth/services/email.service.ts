...
export class EmailService {
  ...
  constructor(
    ...
    this.logger.log(`Email service initialized with Resend (from: ${this.fromEmail})`, 'EmailService');
  }
  ...
  private async sendEmail(to: string, subject: string, html: string) {
    try {
      ...
      this.logger.error(`Failed to send email to ${to}: ${error.message}`, error.stack, 'EmailService');
      throw error;
    }
  }
}
